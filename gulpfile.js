...
let path = {
    ...
    build:{
        html: project_folder +"/",
        css: project_folder + "/assets/ald/css/",
        js: project_folder +"/assets/ald/js/",
        img: project_folder +"/assets/ald/img/",
        image: project_folder +"/assets/ald/image/",
        fonts: project_folder +"/assets/ald/fonts/"
    },
    //исходники
    src:{
        html: [source_folder +"/*.html", "!" + source_folder +"/_*.html"],
        scss: source_folder +"/assets/ald/scss/style.scss",
        js: source_folder +"/assets/ald/js/script.js",
        img: source_folder +"/assets/ald/img/**/*.{jpg,png,svg,gif,ico,webp}",
        image: source_folder +"/assets/ald/image/**/*.{jpg,png,svg,gif,ico,webp}",
        fonts: source_folder + "/assets/ald/fonts/**/*.{eot,ttf,woff,woff2,svg}"
    },
    // пути папок за которыми нужно будет следить
    watch:{
        html: source_folder +"/**/*.html",
        scss: source_folder +"/assets/ald/scss/**/*.scss",
        js: source_folder +"/assets/ald/js/**/*.js",
        img: source_folder +"/assets/ald/img/**/*.{jpg,png,svg,gif,ico,webp}",
        image: source_folder +"/assets/ald/image/**/*.{jpg,png,svg,gif,ico,webp}",
        fonts: source_folder + "/assets/ald/fonts/**/*.{eot,ttf,woff,woff2,svg}"
    },
